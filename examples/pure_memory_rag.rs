...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let docs = vec![
        Document::new(
            "Rust is a systems programming language with memory safety guarantees".to_string(),
        )
        ...
        Document::new(
            "Deep learning is a subset of machine learning with deep neural networks".to_string(),
        )
